...
export function SignIn({setIsAuthenticated, setIsRegistering}){
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p className="mt-10 text-center text-sm text-gray-500">
      Not a member?
      <a href="#" type="button" onClick={() => setIsRegistering(true)} className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign Up</a>
    </p>
  </div>
</div>
    )
